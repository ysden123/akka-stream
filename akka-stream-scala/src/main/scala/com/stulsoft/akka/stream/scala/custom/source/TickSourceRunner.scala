 ...
 * @author Yuriy Stul
 */
object TickSourceRunner extends App with StrictLogging {
  val system = ActorSystem.create("TickSourceRunner")
  implicit val materializer: Materializer = Materializer.createMaterializer(system)

  val sourceGraph: Graph[SourceShape[String], NotUsed] = new TickSource(system)
